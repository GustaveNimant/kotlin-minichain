...
class TestPeerId : BaseIpfsWebserverTest() {
    ...
    fun testPeerId() {
        // setup
        server.enqueue(MockResponse().setBody("{\"Value\":\"QmUfbdU5125Rdwc7pS1wrTwvPDkfyB2jra6xU78TRbeP37\"}\n"))
        ...
        assertThat(peerIdInfo!!.Value).isEqualTo("QmUfbdU5125Rdwc7pS1wrTwvPDkfyB2jra6xU78TRbeP37")
